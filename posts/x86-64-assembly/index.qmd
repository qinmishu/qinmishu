...
When referencing data in the array, you must use an index system to determine which value you are accessing.  The way this is done is called "indexed memory mode". The memory location is determined by the following: 
